...
<body class="bg-slate-900">
  <div class="justify-center m-8 rounded-3xl bg-slate-900 p-8 w-auto h-auto border-2 border-white shadow-[5px_5px_30px_#181824_,-15px_-15px_30px_#242434]">
    ...
    <div>
      <div>
        <img src="{{asset('no-picture.png')}}" alt="Picture" class="float-left rounded-full ml-5 w-20 cursor-pointer mr-12" onclick="location.href='tasks'">
        <img src="{{asset('no-picture.png')}}" alt="Picture" class="rounded-full ml-5 w-20 cursor-pointer m-10" onclick="location.href='#'">
      </div>
