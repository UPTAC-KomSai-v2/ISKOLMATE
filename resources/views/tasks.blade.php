<x-dashboard-layout :name="$name" :position="$position" :back="'/dashboard'">
    <div class="col-span-3 overflow-hidden flex-col  bg-white text-black rounded-3xl flex border-2 hover:cursor-pointer border-white m-2 h-80 ml-0  md:text-2xl font-bold hover:duration-500">
        <a href="input_tasks"><div class="text-left bg-[#8D1436] text-[white] p-[10pt] hover:text-[#FEB71C] hover:duration-500 hover:bg-gradient-to-tr from-slate-800 to-slate-950">Input Tasks</div></a>
    ...
    <div class="col-span-3 overflow-hidden flex-col bg-white text-black rounded-3xl flex border-2 hover:cursor-pointer border-white m-3 h-80 ml-0 md:text-2xl font-bold">
