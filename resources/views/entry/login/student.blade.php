<x-entry-layout :back="route('login')">
    ...
    <div>
        ...
        <form action="{{ route('login') }}" method="POST" class="space-y-4">
            ...
            <input type="text" name="uid" placeholder="Student Number" required class="w-full p-2 rounded-md border border-solid border-[#ccc] text-[#505050] focus:outline-none focus:ring-2 focus:ring-green-500">
