...
<body class="bg-[#1e1e2f]">
  <div class="flex-col justify-center m-8 rounded-3xl bg-[#1e1e2f] p-8 w-auto h-auto shadow-[10px_10px_5px_#181824_,-15px_-15px_30px_#242434]">
    ...
    <div class="rounded-lg m-2 m-2 grid gap-4 grid-cols-3 w-auto h-80 ">
      <div onclick="location.href='#'" class="relative bg-[#1e1e2f] text-white rounded-3xl flex border-2 hover:shadow-[inset_35px_35px_20px_#181824_,_inset_-35px_-35px_20px_#242434] hover:cursor-pointer border-white m-2 h-80 ml-0 justify-center items-center md:text-2xl font-bold">
        <div class="absolute bg-red-400 w-10 h-10 rounded-full right-[-10px] top-[-10px]" id="checkAnnouncements" hidden></div>
        ANNOUNCEMENTS
      </div>
      <div onclick="location.href='#'" class="bg-[#1e1e2f] text-white rounded-3xl flex border-2 hover:shadow-[inset_35px_35px_20px_#181824_,_inset_-35px_-35px_20px_#242434] hover:cursor-pointer border-white m-2 h-80 justify-center items-center md:text-2xl font-bold">TASKS</div>
      <div onclick="location.href='#'" class="bg-[#1e1e2f] text-white rounded-3xl flex border-2 hover:shadow-[inset_35px_35px_20px_#181824_,_inset_-35px_-35px_20px_#242434] hover:cursor-pointer border-white m-2 h-80 mr-0 justify-center items-center md:text-2xl font-bold">AVAILABILITY</div>
    </div>
  </div>
</body>
</html>