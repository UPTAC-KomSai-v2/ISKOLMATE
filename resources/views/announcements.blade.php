<x-dashboard-layout :name="$name" :position="$position" :back="'/dashboard'">
    <div class="col-span-2 overflow-hidden flex-col  bg-white text-black rounded-3xl flex border-2  border-white m-2 h-80 ml-0  md:text-2xl font-bold">
    ...
    <div class="col-span-2 overflow-hidden flex-col bg-white text-black rounded-3xl flex border-2  border-white m-3 h-80 ml-0 md:text-2xl font-bold">
