...
<body class="bg-[#1e1e2f]">
  <div class="flex-col justify-center m-8 rounded-3xl bg-[#1e1e2f] p-8 w-auto h-auto shadow-[10px_10px_5px_#181824_,-15px_-15px_30px_#242434]">
    ...
    <div class="rounded-lg m-5 flex flex-col w-auto h-80 text-white justify-between items-center md:text-5xl font-bold">
      ...
      <div onclick="location.href='announcements'" class="bg-fuchsia-900 w-80 text-white rounded-3xl flex border-2 hover:shadow-[inset_35px_35px_20px_#181824_,_inset_-35px_-35px_20px_#242434] hover:cursor-pointer border-white m-2 h-20 items-center md:text-2xl font-bold">Go back to Announcements Page</div>
    </div>
  </div>
</body>
</html>